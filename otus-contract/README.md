...
Цель: Закрепить и систематизировать занания полученные на курсе "Microservice Architecture". Получить практические навыки применения технологий, актуальных в сфере разработки и  проектирования систем на базе микросервисной архитектуры.
