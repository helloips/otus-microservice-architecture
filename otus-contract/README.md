...
### Клиент
Потенциальный студент должен иметь возможность сохранить персональный данные (в лице "ЕСИА" и "Госуслуги"?), требуемые для договора, а так же подтвертить факт подписания (в лице "Госключ"?):
